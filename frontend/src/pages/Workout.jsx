...
import { 
  Dumbbell, Play, Clock, Target, RefreshCw, 
  Loader2, ChevronDown, ChevronUp, ExternalLink, Youtube
} from 'lucide-react'
                      ...
                      >
                        <div className="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                          <img 
                            ...
                            onError={(e) => {
                              e.target.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect fill="%231a1f35" width="100" height="100"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="%2300d4ff" font-size="24">💪</text></svg>'
                            }}
                          />
                        </div>
